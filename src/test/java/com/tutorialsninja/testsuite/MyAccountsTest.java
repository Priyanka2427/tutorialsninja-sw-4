...
public class MyAccountsTest extends BaseTest {
    ...
    public void verifyThatUserRegisterAccountSuccessfully(){
        ...
        //3.4 Enter Last Name
        registerPage.EnterLastname("Gajera");
        //3.5 Enter Email
        registerPage.EnterEmail("prgajera@gmail.com");
        //3.6 Enter Telephone
        registerPage.EnterTelephoneNo("0977654769");
        //3.7 Enter Password
        registerPage.EnterPassword("143Priya");
        //3.8 Enter Password Confirm
        registerPage.EnterPasswordConfirm("143Priya");
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully(){
        ...
        logInPage.enterEmail("prgajera@gmail.com");
        //4.4 Enter Password
        logInPage.enterPassword("143Priya");
